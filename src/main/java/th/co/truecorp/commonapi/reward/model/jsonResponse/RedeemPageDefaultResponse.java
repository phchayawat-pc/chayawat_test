...
public class RedeemPageDefaultResponse<T> {
	...
	public RedeemPageDefaultResponse(HashMap<String, Object> tv, TransactionResult transactionResultdata) {

		T dataObject = (T) tv.get(Constant.TRANSACTION_RESPONSE_KEY);
		PageDTO page1 = (PageDTO) tv.get("paging");
