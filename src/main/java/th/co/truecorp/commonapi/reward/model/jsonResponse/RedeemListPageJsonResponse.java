...
public class RedeemListPageJsonResponse<T> extends GenericJsonResponse<T> {
    ...
    public RedeemListPageJsonResponse(HashMap<String, Object> tv, TransactionResult transactionResult, T resp, Object debug, PageDTO page) {
