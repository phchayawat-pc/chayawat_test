...
@Component
public class ShelfDtacInquiryShelfDetailEndpoint {

    private static final Logger log = LoggerFactory.getLogger(ShelfDtacInquiryShelfDetailEndpoint.class);
    ...
    public EndpointResult getShelfDtacInquiryShelfDetail(Map<String, Object> tv) throws Exception {
...
//        queryParams.put("lang",tv.get("lang").toString().substring(0,1)); // use: EN=E, TH=T
        queryParams.put("id",tv.get("id"));
        queryParams.put("phoneNumber",tv.get("phoneNumber"));
        queryParams.put("customerNumber",tv.get("customerNumber"));
        queryParams.put("type",tv.get("type"));//segment decrypt from FE
        queryParams.put("shelfType",tv.get("shelfType"));
        queryParams.put("bannerType",tv.get("bannerType"));
        queryParams.put("relatedParty.type",tv.get("relatedParty.type"));
        queryParams.put("relatedParty.description",tv.get("relatedParty.description"));
