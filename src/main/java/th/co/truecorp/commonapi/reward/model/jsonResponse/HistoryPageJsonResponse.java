...
public class HistoryPageJsonResponse<T> extends GenericJsonResponse<T> {
    ...
    public HistoryPageJsonResponse(HashMap<String, Object> tv, TransactionResult transactionResult, T resp, Object debug, PageDTO page) {
