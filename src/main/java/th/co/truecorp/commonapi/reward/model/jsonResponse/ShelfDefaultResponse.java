...
import th.co.truecorp.commonapi.reward.model.HistoryDetailRsp;
...
public class ShelfDefaultResponse<T> {
	...
	public ShelfDefaultResponse(HashMap<String, Object> tv, TransactionResult transactionResultdata) {
